...
% FIG panel if manualLabelHome=fullfile(analysis_dir_path, 'PN_analysis/alldata');
% SUP FIG panel if manualLabelHome=fullfile(analysis_dir_path, 'PN_analysis/test');
figure %7
hold on;
