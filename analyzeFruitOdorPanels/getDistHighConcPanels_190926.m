...
imagehomedir = '/Users/mattchurgin/Dropbox (Harvard University)/flyimaging/HighConc_Grape4_applecidervinegar7_pineapple8_OdorPanels';
cd(imagehomedir)

odornames=[{'air'},{'3-octanol'},{'1-hexanol'},{'ethyl lactate'},{'grape'},{'2-heptanone'},{'1-pentanol'},{'apple cider vinegar'},{'pineapple'},{'hexyl acetate'},{'4-methylcyclohexanol'},{'pentyl acetate'},{'1-butanol'}];
...
flyname = 'fly4';
if lobe == 0
fname =[ flyname '/rightLobe/clusterResponses_Volumes' trial '.mat'];
else
fname =[flyname '/leftLobe/clusterResponses_Volumes' trial '.mat'];
end
odornames=[{'air'},{'3-octanol'},{'1-hexanol'},{'ethyl lactate'},{'grape'},{'2-heptanone'},{'1-pentanol'},{'apple cider vinegar'},{'pineapple'},{'hexyl acetate'},{'4-methylcyclohexanol'},{'pentyl acetate'},{'1-butanol'}];
file =['/Users/mattchurgin/Dropbox (Harvard University)/flyimaging/HighConc_Grape4_applecidervinegar7_pineapple8_OdorPanels/190925_gh146gcam_age14days_nobehavior/' fname];
load(file)
%
